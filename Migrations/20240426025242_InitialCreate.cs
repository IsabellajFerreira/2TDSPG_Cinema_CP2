        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroCliente = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngressosDisponiveis = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FilmesId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    SessoesId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmeSessao", x => new { x.FilmesId, x.SessoesId });
                    table.ForeignKey(
                        name: "FK_FilmeSessao_Filmes_FilmesId",
                        column: x => x.FilmesId,
                        principalTable: "Filmes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmeSessao_Sessoes_SessoesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessaoId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingressos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ingressos_Reserva_ReservaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmeSessao_SessoesId",
                table: "FilmeSessao",
                column: "SessoesId");

            migrationBuilder.CreateIndex(
                name: "IX_Ingressos_ReservaId",
                table: "Ingressos",
                column: "ReservaId");
